    ...
    def run(self, question: str):
        ...
        while current_step < self.max_steps:
            ...
            prompt = REACT_PROMPT_TEMPLATE.format(
                tools=tools_desc, question=question, history=history_str, current_date=current_date
            )
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Run the ReAct agent with a question.")
    parser.add_argument("-q", "--question", nargs="*", help="Question to ask the agent (quotes optional). If omitted, an interactive prompt will be shown.)")
    ...
    if args.question:
        ...
        try:
            question = input("请输入要提问的问题: ").strip()
